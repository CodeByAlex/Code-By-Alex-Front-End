...
export class AbilitiesComponent implements OnInit {
  ...
  constructor() {
    this.languages = [new Ability("Languages", "Java", 5), new Ability("Languages", "HTML", 5), new Ability("Languages", "CSS", 4),
      new Ability("Languages", "Typescript", 4), new Ability("Languages", "SQL", 3), new Ability("Languages", "JQuery", 2), new Ability("Languages", "Python", 1), new Ability("Languages", "NodeJs", 1)];
    this.frameworks = [new Ability("Frameworks", "Angular", 4)];
    this.testTools = [new Ability("Test Tools", "Junit", 5), new Ability("Test Tools", "Fitnesse", 5), new Ability("Test Tools", "Postman", 3), new Ability("Test Tools", "Jasmine", 3)];
    ...
    this.devTools = [new Ability("Development Tools", "Webstorm", 5), new Ability("Development Tools", "Eclipse", 5), new Ability("Development Tools","Netbeans", 4),  new Ability("Development Tools","GitLab", 4),
